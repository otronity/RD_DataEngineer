...
--
-- ЩО ЗМІНИЛОСЬ ПРОТИ L05: теж `incremental` за `pickup_date` — інакше кожен
-- щоденний прогін перебудовував би всю широку таблицю з нуля.
...
WHERE f.pickup_date = DATE '{{ var("ds") }}'
{% endif %}
